#!/usr/bin/env python
# ============================================================================== #
# Data Augmentations in Resnet-18 with CIFAR-10 and STL-10
...
def ablation(img_sz):
    ...
    train(ResNet18().to(DEVICE), data.get_cifar10(), start_time)
    start_time = str(time.time())
    train(ResNet18().to(DEVICE), data.get_cifar10(augs_options(img_sz)), start_time)
